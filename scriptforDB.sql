...
ALTER TABLE `ShoppingCart_Item` ADD FOREIGN KEY (`user_id`) REFERENCES `User` (`id`);

ALTER TABLE `ShoppingCart_Item` ADD FOREIGN KEY (`product_id`) REFERENCES `Product` (`id`);
